                   ...
                   <?php }?>
                                 ...
                                 <div class="col-lg-12">
                                  ...
                                  <div class="error_msg"><?php echo form_error('user_type'); ?></div>
                                       ...
                                       <!--  <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                        <div class="form-group agent_proof" >
                            ...
                            <div class="col-lg-12">
                                <div class="form-group adrs" >
                                    ...
                                    <input type="text" name="address" id="address" class="form-control" placeholder="Address with pincode" value="<?php echo $user_info[0]->address?>" autocomplete="off" required>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group agent_ser" >
                                    ...
                                    <textarea rows="6" name="agent_service" id="agent_service" class="form-control" placeholder="Agent service" autocomplete="off" required><?php echo $user_info[0]->agent_service;?></textarea>
                        ...
                        <?php } if($user_info[0]->user_type!="individual"){?>
                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="form-group agent_buil_ofc_photo" >
