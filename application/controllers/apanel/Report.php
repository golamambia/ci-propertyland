...
function report_list($offset=0){
      ...
      if(count($_GET) > 0){
        $config['first_url'] = site_url("apanel/report/report_list".'?'.http_build_query($_GET));
      }

        $config["base_url"]=site_url("apanel/report/report_list"); 
      ...
      //print_r($data);exit();
        ...
        $this->load->view('apanel/header',compact('report_list','page_link','title'));

        $this->load->view('apanel/report_list');
   ...
   $data['user']=$chat_user;
        ...
        $this->load->view('apanel/report_chat_list');
     ...
     function complaint_list($offset=0){
      ...
      if(count($_GET) > 0){
        $config['first_url'] = site_url("apanel/report/complaint_list".'?'.http_build_query($_GET));
      }

        $config["base_url"]=site_url("apanel/report/complaint_list"); 
      ...
      //print_r($data);exit();
        ...
        $this->load->view('apanel/header',compact('complaint_list','page_link','title'));

        $this->load->view('apanel/complaint_list');
   ...
   $data['user']=$chat_user;
        ...
        $this->load->view('apanel/complaint_chat_list');
