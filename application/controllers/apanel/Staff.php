...
class Staff extends CI_Controller {
	...
	{
		$data['datatable']=$this->db->query("SELECT d.name as manager,st.*,c.countryname FROM staff_table as st LEFT JOIN country as c on(st.country=c.id) left join staff_table d on d.id=st.manager_name WHERE st.id!=''")->result();
       ...
       //echo $this->db->last_query();
		...
		$this->load->view('apanel/stafflist');
		$this->load->view('apanel/footer');
	}

    public function industry_selection()
    {
        $query=$this->General_model->show_data_id('industry_selection','','','get','');
        
        $data['datatable']=$query;

        $data['title']="Industry Selection || List";

        //echo "<pre>"; print_r($data); exit();

        $this->load->view('apanel/header',$data);
        $this->load->view('apanel/industry_selection');
        $this->load->view('apanel/footer');
    }
	...
	public function staff_edit($id)
	{
        $data['country_list']=$this->General_model->show_data_id('country','','','get','');
         $data['manager_list']=$this->General_model->show_data_id('staff_table','manager_staff','user_type','get','');
        ...
        $this->load->view('apanel/header',$data);
        $this->load->view('apanel/staff_edit');
        $this->load->view('apanel/footer');
	}

        public function industry_selection_edit($id)
    {
        
        $query=$this->General_model->show_data_id('industry_selection',$id,'id','get','');
        
        $data['industry_selection']=$query;


        $data['title']="industry_selection || Edit";
        $this->load->view('apanel/header',$data);
        $this->load->view('apanel/industry_selection_edit');
        $this->load->view('apanel/footer');
    }
