...
if(!$this->session->userdata('is_logged_in')==1)
  ...
  public function pending()
  {
    ...
    $this->load->view('apanel/header',$data);
    $this->load->view('apanel/pending_list');
    $this->load->view('apanel/footer');
  ...
  public function complaint_ads()
  {
    ...
    $this->load->view('apanel/header',$data);
    $this->load->view('apanel/ads_complaint_list_view');
    $this->load->view('apanel/footer');
  ...
  public function report_ads()
  {
    ...
    $this->load->view('apanel/header',$data);
    $this->load->view('apanel/ads_report_list_view');
    $this->load->view('apanel/footer');
...
$data['title']='Ads details';
    ...
    $this->load->view('apanel/header',$data);
    $this->load->view('apanel/ads_list_view');
    $this->load->view('apanel/footer');
