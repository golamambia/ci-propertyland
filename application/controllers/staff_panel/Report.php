...
function report_list($offset=0){
      ...
      if(count($_GET) > 0){
        $config['first_url'] = site_url("staff_panel/report/report_list".'?'.http_build_query($_GET));
      }

        $config["base_url"]=site_url("staff_panel/report/report_list"); 
      ...
      //print_r($data);exit();
        ...
        $this->load->view('staff_panel/header',compact('report_list','page_link','title'));

        $this->load->view('staff_panel/report_list');
   ...
   $data['user']=$chat_user;
        ...
        $this->load->view('staff_panel/report_chat_list');
     ...
     function complaint_list($offset=0){
      ...
      if(count($_GET) > 0){
        $config['first_url'] = site_url("staff_panel/report/complaint_list".'?'.http_build_query($_GET));
      }

        $config["base_url"]=site_url("staff_panel/report/complaint_list"); 
      ...
      //print_r($data);exit();
        ...
        $this->load->view('staff_panel/header',compact('complaint_list','page_link','title'));

        $this->load->view('staff_panel/complaint_list');
   ...
   $data['user']=$chat_user;
        ...
        $this->load->view('staff_panel/complaint_chat_list');
