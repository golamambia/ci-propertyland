...
class Adsdata extends CI_Controller {
  ...
  public function index()
  {
    ...
    $this->load->view('manager_panel/adslist');
  ...
  public function complaint_ads()
  {
    ...
    $this->load->view('manager_panel/header',$data);
    $this->load->view('manager_panel/ads_complaint_list_view');
    $this->load->view('manager_panel/footer');
  ...
  public function report_ads()
  {
    ...
    $this->load->view('manager_panel/header',$data);
    $this->load->view('manager_panel/ads_report_list_view');
    $this->load->view('manager_panel/footer');
...
$data['title']='The Local Business';
    ...
    $this->load->view('manager_panel/header',$data);
    $this->load->view('manager_panel/ads_list_view');
    $this->load->view('manager_panel/footer');
