...
class Main extends CI_Controller{
    ...
    function __construct()
    {
        ...
        $this->load->library('email');
            ...
            {
                redirect('manager_panel/home', 'refresh');
            }
   ...
   public function login()
   {
     ...
     $data['title'] = "Abc || Manager Panel ";
     $this->load->view('manager_panel/login',$data);
   }
    public function forgot_password()
   {
     $data['title'] = "Abc || Admin Panel ";
     $this->load->view('manager_panel/forgot_password',$data);
   }
 public function pass_validation()
    {
		...
		if ($this->form_validation->run() == FALSE){
			...
			redirect('manager_panel/main/forgot_password');
		} else {
...
//exit();
   ...
   //==================================Form validation===========================================
    ...
    public function login_validation()
    {
		...
		if($result=='mail_not'){
                ...
                $this->session->set_flashdata('error','Email verification not complete1');
   ...
   delete_cookie('pass');  
			...
			$this->session->set_userdata('is_logged_in_mng', '1');
			redirect('manager_panel/home');
			}
