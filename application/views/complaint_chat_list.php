    ...
    <div class="main_area dashboard pb-3 pt-3">
        <div class="container">
            <div class="dashboard_area">
             ...
             $user_last_activity =  $value->cmp_entry_date;
             ...
             $user_photo=$value->user_photo;
                                    ...
                                    <li class="offerer">
                                      ...
                                      <?php }?>
                                        ...
                                        <div class="user-name">
                                           <h4><a href="<?php echo base_url(); ?>report/complaint_msg_list?ads=<?=base64_encode($ads);?>&user=<?=base64_encode($value->id);?>"><?=$value->name;?></a></h4>
                                           <h5><!-- <?=$status;?> --><?php $msg_no=unreadComplaint($value->id,$value->lbcontactId,$this->session->userdata('front_sess')['userid']);
      ...
      <div class="chat-header clearfix">
       <?php if($chat_uphoto!=''){
        ...
        <div class="chat-about">
          ...
          <div class="chat-num-messages">total <?=totalChatComplaint($user,$ads,$this->session->userdata('front_sess')['userid']);?> messages</div>
...
">Clear chat &nbsp;<i class="fa fa-trash"></i></div>
          ...
          <?php
                          ...
                          $chat_time = new DateTime($value->cmp_entry_date);
                                      ...
                                      //echo  $value->qt_userid;
                                        if($value->cmp_userid==$this->session->userdata('front_sess')['userid'])
                              {
                               $user_name = 'You';
          ...
          <li class="clearfix">
            ...
            <div class="message other-message float-right">
             <?=$value->cmp_message;?>
                              ...
                              {
                               $user_name = getUser($value->cmp_userid);
      ...
      <div class="chat-message clearfix">
        <form method="post">
        <textarea name="cmp_message" id="message-to-send" placeholder ="Type your message" rows="3" required></textarea>
