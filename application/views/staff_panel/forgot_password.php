    ...
    <div class="col-12 d-flex align-items-center justify-content-center">
       <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
            <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
              ...
              <?php }?>
                        <form class="form-horizontal"  action="<?php echo base_url();?>staff_panel/main/pass_validation" method="POST" >
                ...
                <div class="card-footer border-0">
                    <p class="float-sm-left text-center"><a href="<?php echo base_url();?>staff_panel/main/login" class="card-link">Login</a></p>
