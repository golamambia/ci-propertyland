...
<div class="row">
    ...
    <div class="col-xl-3 col-lg-6 col-12">
        <div class="card">
            <a href="<?=base_url();?>/staff_panel/report/complaint_list">
            <div class="card-content">
                <div class="media align-items-stretch">
                    ...
                    <div class="p-2 bg-gradient-x-warning white media-body">
                        <h5 style="font-size: 13px;font-weight: 500;">Unread Complain</h5>
                        <h5 class="text-bold-400 mb-0"><i class="ft-arrow-up"></i> <?=countComplaint();?></h5>
                    </div>
                </div>
            </div>
        </a>
    ...
    <div class="col-xl-3 col-lg-6 col-12">
        <div class="card">
            <a href="<?=base_url();?>/staff_panel/report/">
            <div class="card-content">
                <div class="media align-items-stretch">
                    ...
                    <div class="p-2 bg-gradient-x-success white media-body">
                        <h5 style="font-size: 13px;font-weight: 500;">Unread Report</h5>
                        <h5 class="text-bold-400 mb-0"><i class="ft-arrow-up"></i> <?=countReport();?></h5>
                    </div>
                </div>
            </div>
            </a>
