<div class="content-wrapper">
        ...
        <div class="content-header-left col-md-6 col-12 mb-2">
            ...
            <h3 class="content-header-title mb-0">Staff View</h3>
            ...
            <div class="row breadcrumbs-top">
              ...
              <div class="breadcrumb-wrapper col-12">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo base_url();?>staff_panel/staff/">Staff List</a>
...
<?php }?>
                        ...
                        <form class="form"  method="post" enctype="multipart/form-data" action="<?php echo base_url();?>staff_panel/1staff/1staff_edit_post/<?php echo $user[0]->id?>">
                            ...
                            <div class="form-body">
                                ...
                                <h4 class="form-section"><i class="ft-calendar"></i>Staff Info</h4>
                                        ...
                                        <div class="form-group">
                                           ...
                                           <select class="form-control" name="user_type" id="user_type" required style="pointer-events: none;">
                            ...
                            <div class="form-actions">
                               ...
                               <a href="<?php echo base_url();?>staff_panel/staff/" class="btn btn-warning mr-1">
