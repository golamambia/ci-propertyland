              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <section class="contact-form">
                    <form  class="contact-input" method="post" action="<?php echo base_url();?>staff_panel/notification/notice_post">
            ...
            <table id="example" class="table table-striped table-bordered base-style ">
              ...
              <tbody>
               ...
               ?>
                ...
                <a href="<?php echo base_url();?>staff_panel/notification/notice_delete/<?=$value->nid;?>" onclick="return confirm('Are you sure to delete?')"><span class="badge badge-danger" title="Click here for delete"><i class="fa fa-trash" aria-hidden="true"></i> Delete</span></a>
             ...
             aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <section class="contact-form">
                    <form  class="contact-input" method="post" action="<?php echo base_url();?>staff_panel/notification/notice_edit/<?=$value->nid;?>">
                      <div class="modal-header">
