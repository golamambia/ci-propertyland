    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
        	...
        	<h4 class="card-title">
            <a href="<?=base_url();?>staff_panel/report/" class="btn btn-primary mr-1" >
              ...
              <tbody>
               ...
               <?php
                          ...
                          ?>
                           <tr class="dview<?=$i;?>">
                             <?php 
                              if($value->rpt_userid==$ads_owner_list[0]->id)
                              {
                              ?>
                                 ...
                                 <td class="action-td">
                                  <a target="_blank" href="<?=base_url();?>adsview/dataview?ads=<?=base64_encode($ads);?>" class="view_btn"  title="Click to view ad"><i class="fview fa fa-eye"  aria-hidden="true"></i></a>
                                   <a href="<?php echo base_url();?>staff_panel/adsdata/adsdata_view?view=<?=base64_encode($value->lbcontactId);?>"><span class="badge bg-primary" title="Click here for view & action"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> View / Action</span></a>
