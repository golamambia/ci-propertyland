...
<div class="col-lg-12">
            ...
            <option <?php if($result[0]->jobType=='REGULAR'){echo'selected="selected"'; } ?> value="REGULAR">REGULAR</option>
            <option <?php if($result[0]->jobType=='CONTRACT'){echo'selected="selected"'; } ?> value="CONTRACT">CONTRACT</option>
            <option <?php if($result[0]->jobType=='FREELANCER'){echo'selected="selected"'; } ?> value="FREELANCER">FREELANCER</option>
...
<div class="col-lg-12">
            ...
            <option <?php if($result[0]->employnentType=='Full'){echo'selected="selected"'; } ?> value="Full">Full</option>
            <option <?php if($result[0]->employnentType=='Part Time'){echo'selected="selected"'; } ?> value="Part Time">Part Time</option>
...
<div class="col-lg-12">
                                            <div class="form-group">
                                              <label>Company Name<spsn> *</spsn></label>
                                                <input name="companyName" type="text" class="form-control" placeholder="Company Name" value="<?=$result[0]->companyName;?>" required />
...
<div class="col-lg-12">
                                            <div class="form-group">
                                              <label>COMPANY JOB ID<spsn> *</spsn></label>
                                                <input name="cOMPANY_JOB_ID" type="text" class="form-control" placeholder="COMPANY JOB ID" value="<?=$result[0]->cOMPANY_JOB_ID;?>" required />
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                              <label>JOB LINK<spsn> *</spsn></label>
                                                <input name="jOBLINK" type="text" class="form-control" placeholder="JOB LINK" value="<?=$result[0]->jOBLINK;?>" required />
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                              <label>RELEVANT YEAR OF EXPERIENCE<spsn> *</spsn></label>
                                                <input name="jobEXPERIENCE" type="text" class="form-control" placeholder="RELEVANT YEAR OF EXPERIENCE" value="<?=$result[0]->jobEXPERIENCE;?>" required />
...
<div class="col-lg-12">
          ...
          <input name="POSITION_OPEN_TILl" type="date" class="form-control"  value="<?=$result[0]->POSITION_OPEN_TILl;?>" required />
