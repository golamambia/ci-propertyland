<div class="content-wrapper">
        ...
        <div class="content-header-left col-md-6 col-12 mb-2">
            ...
            <h3 class="content-header-title mb-0">Industry Selection Edit</h3>
...
<?php }?>
                        ...
                        <form class="form"  method="post" enctype="multipart/form-data" action="<?php echo base_url();?>apanel/staff/industry_selection_edit_post/<?php echo $industry_selection[0]->id; ?>">
                            ...
                            <div class="form-body">
                                ...
                                <h4 class="form-section"><i class="ft-calendar"></i>Industry Selection Info</h4>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" class="form-control" placeholder="Title" name="industry" value="<?php echo $industry_selection[0]->industry; ?>"  required>
