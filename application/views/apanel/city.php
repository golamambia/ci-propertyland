              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <section class="contact-form">
                    <form  class="contact-input" method="post" action="<?php echo base_url();?>apanel/location/city_post">
                      ...
                      <div class="modal-body">
                         <fieldset class="form-group col-12">
                          ...
                          <select class="contact-name form-control" name="countryid"  id="countryid" onchange="get_state();" required>
...
<div id="result">
  ...
  <select class="contact-name form-control" name="" required>
                        ...
                        <fieldset class="form-group col-12">
                          <input type="text" id="state_name" class="contact-name form-control" placeholder="City Name" name="name" required>
                        </fieldset>
            ...
            <table id="example" class="table table-striped table-bordered base-style ">
              ...
              <tbody>
               ...
               ?>
                ...
                <a href="<?php echo base_url();?>apanel/location/city_delete/<?=$value->cid;?>" onclick="return confirm('Are you sure to delete?')"><span class="badge badge-danger" title="Click here for delete"><i class="fa fa-trash" aria-hidden="true"></i> Delete</span></a> 
...
<script type="text/javascript">
  ...
  function get_state(){
    ...
    $.post( "<?php echo base_url(); ?>apanel/location/countrywise_state",{countryid:countryid}, function( data ) {
  $( "#result" ).html( data );
});
