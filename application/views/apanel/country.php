...
<div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-12 col-12 mb-2">
            <h3 style="text-align: center;" class="content-header-title mb-0">Country</h3>
            ...
            <table id="example" class="table table-striped table-bordered base-style ">
              ...
              <tbody>
               ...
               ?>
                ...
                <a href="<?php echo base_url();?>apanel/location/cat_delete/<?=$value->id;?>" onclick="return confirm('Are you sure to delete?')"><span class="badge badge-danger" title="Click here for delete"><i class="fa fa-trash" aria-hidden="true"></i> Delete</span></a>
             ...
             aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <section class="contact-form">
                    <form  class="contact-input" method="post" action="<?php echo base_url();?>apanel/location/country_edit/<?=$value->id;?>">
                      <div class="modal-header">
                      ...
                      <div class="modal-body">
                        ...
                        <fieldset class="form-group col-12">
                          <input type="text" id="cat<?=$value->id;?>" class="contact-name form-control" placeholder="Name" name="countryname" value="<?=$value->countryname;?>" required>
                        </fieldset>
