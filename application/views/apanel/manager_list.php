...
<div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-12 col-12 mb-2">
            <h3 style="text-align: center;" class="content-header-title mb-0">Manager List</h3>
...
echo $contchat_new;
 ?>                                  
                                 ...
                                 <td class="action-td">
                                  <a href="<?php echo base_url(); ?>apanel/support/chat/?chat_id=<?php echo $value->id; ?>" class="view_btn"  title="Click to view ad"><i class="fview fa fa-eye"  aria-hidden="true"></i></a></td>
