...
<div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-12 col-12 mb-2">
            <h3 style="text-align: center;" class="content-header-title mb-0">Sub-Category</h3>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">
            <a href="javascript:void(0)" class="btn btn-primary mr-1" data-toggle="modal" data-target="#AddContactModal">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <section class="contact-form">
                    <form  class="contact-input" method="post" action="<?php echo base_url();?>apanel/category/sub_catpost">
...
<?php }?>
            ...
            <table id="example" class="table table-striped table-bordered base-style ">
              <thead>
                <tr>
                  <th>Category</th>
                  <th>Name</th>
                  <th>For home page (4 only)</th>
                  <th>Top Category for home page (4 only)</th>
              ...
              <tbody>
               ...
               ?>
                 <tr>
                  <td><?=$value->name;?></td>
                  <td><?=$value->subname;?></td>
                  <td><input style="cursor: pointer;" id="home_page_clk<?=$value->sid;?>" type="checkbox" onclick="home_page_clk('home_page_clk','<?=$value->sid;?>','home')" <?php if($value->home_page==1){echo"checked";}?>></td>
                 <td><input style="cursor: pointer;" id="home_page_top<?=$value->sid;?>" type="checkbox" onclick="home_page_clk('home_page_top','<?=$value->sid;?>','top')" <?php if($value->top_category==1){echo"checked";}?>  ></td>
              ...
              <!--   <a href="<?php echo base_url();?>apanel/category/subcat_delete/<?=$value->sid;?>" onclick="return confirm('Are you sure to delete?')"><span class="badge badge-danger" title="Click here for delete"><i class="fa fa-trash" aria-hidden="true"></i> Delete</span></a> -->
             ...
             aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <section class="contact-form">
                    <form subcategory_edit class="contact-input" method="post" action="<?php echo base_url();?>apanel/category/subcategory_edit/<?=$value->sid;?>">
                      <div class="modal-header">
      ...
      <script type="text/javascript">
        function home_page_clk(field,subid,tab){
          //alert(val);
		  if($('#'+field+subid).not(':checked').length){
       	var action="no";
		var val=0;
    	}else{
     	var action="yes";
		var val=1;
		  ...
		  $.ajax({
			  method:'post',
			  url:'<?=base_url();?>apanel/category/set_sub_homepage',
			  data:{subcat:subid,val:val,action:action,tab:tab},
			  cache:false,
