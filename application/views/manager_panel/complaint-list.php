    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">
            <a href="<?php echo base_url();?>manager_panel/adsdata/complaint_ads" class="btn btn-primary mr-1" >
            ...
            <table id="example" class="table table-striped table-bordered base-style ">
              ...
              <tbody>
               ...
               ?>
                ...
                <a href="<?php echo base_url();?>manager_panel/adsdata/adsdata_view?view=<?=base64_encode($value->cmp_adsid);?>"><span class="badge bg-primary" title="Click for active or deactive"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> View</span></a>
