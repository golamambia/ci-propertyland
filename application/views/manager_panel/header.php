...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo base_url();?>assets_front/images/favicon.png">
      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item mr-auto"><a class="navbar-brand" href="<?php echo base_url();?>manager_panel/home"><img style="width: 29px;height: 29px;
border-radius: 50%;" class="brand-logo" alt="stack admin logo" src="<?=base_url();?>uploads/logo/<?=$this->session->userdata('logged_in_mng')['logo'];?>">
          ...
          <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              	<span class="avatar avatar-online"><img src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name"><?=ucfirst($this->session->userdata('logged_in_mng')['name']);?></span></a>
                <div class="dropdown-menu dropdown-menu-right">
                	<a class="dropdown-item" href="<?php echo base_url();?>manager_panel/settings/profile"><i class="ft-user"></i>Profile</a>
                	<a class="dropdown-item" href="<?php echo base_url();?>manager_panel/settings/change_password"><i class="ft-lock"></i>Change Password</a>

                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="<?php echo base_url();?>manager_panel/home/logout"><i class="ft-power"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
    ...
    <!-- END: Header-->
<?php $this->load->view('manager_panel/sidebar');?>