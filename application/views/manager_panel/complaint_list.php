                           ...
                           <tbody>
                            ...
                            foreach($complaint_list as $result){
                              ...
                              <tr class="dview<?=$i;?>">
                                 ...
                                 <td>
                                  <a href="<?=base_url();?>manager_panel/report/complaint_msg_list?ads=<?=base64_encode($result->lbcontactId);?>"><?=$result->title;?></a></td>

                                   <td class="ads-details-td">
                                  <?=unreadComplaintList('',$result->lbcontactId,'');?></td>
                                 <td class="action-td">
