...
<?php }?>
                        ...
                        <form class="form"  method="post" enctype="multipart/form-data" action="<?php echo base_url();?>manager_panel/staff/staff_edit_post/<?php echo $user[0]->id?>">
                            <div class="form-body">
                            ...
                            <div class="form-actions">
                               <a onclick="goBack()" href="#" class="btn btn-warning mr-1">
