...
$sender_name=$sender[0]->name;
if($this->session->userdata('logged_in_mng')['name']==$sender_name){
 echo "You";
}else{
  echo $sender_name;
}
...
?>
      ...
      <div class="chat-message clearfix">
          ...
          <form action="<?php echo base_url(); ?>manager_panel/support/post_staff_chat" method="post">
