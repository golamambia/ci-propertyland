...
echo $contchat_new;
 ?>                                  
                                 ...
                                 <td class="action-td">
                                  <a href="<?php echo base_url(); ?>manager_panel/support/chat/?chat_id=<?php echo $value->id; ?>" class="view_btn"  title="Click to view ad"><i class="fview fa fa-eye"  aria-hidden="true"></i></a></td>
