                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                              <label>Event Name<spsn> *</spsn></label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                              ...
                                              <input type="date" id="event_date" name="event_start_date" class="form-control" placeholder="Event Date" required>
...
<?php } ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="search_keyword" class="form-control " placeholder="Search Keyword" ><?=set_value('search_keyword');?></textarea>
