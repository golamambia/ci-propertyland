...
<select name="type" class="form-control" >
  <option value="">Select Type</option>
    <option <?php if($result[0]->type=='Feed'){echo 'selected="selected"';} ?> value="Feed">Feed</option>
      <option <?php if($result[0]->type=='Request'){echo 'selected="selected"';} ?> value="Request">Request</option>
</select>                                                
                                         ...
                                         <div class="col-lg-12">
                                            <div class="form-group">
                                               <label>Pincode/Zipcode<span> </span></label>
                                                <input type="text" name="zipcode" id="zipcode" class="form-control" value="<?=$result[0]->zipcode;?>" placeholder="Pincode/Zipcode"  />
