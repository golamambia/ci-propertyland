                            ...
                            <div class="dashboard_mainboby">
                                ...
                                <div class="form_area">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <h4>Job Type</h4>
                                            <p><?=$result[0]->jobType; ?></p>

                                             
                                        </div>

                                        <div class="col-lg-6">
                                            <h4>Employnent Type</h4>
                                            <p><?=$result[0]->employnentType; ?></p>
...
<div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <h4>Company Job ID</h4>
                                            <p><?=$result[0]->cOMPANY_JOB_ID; ?></p>

                                             
                                        </div>
                                        <div class="col-lg-6">
                                            <h4>Job Link</h4>
                                            <p><?=$result[0]->jOBLINK; ?></p>

                                             
                                        </div>
                                        <div class="col-lg-6">
                                            <h4>Relevant Year Of Experience</h4>
                                            <p><?=$result[0]->jobEXPERIENCE; ?></p>

                                             
                                        </div>
                                        <div class="col-lg-6">
                                            <h4>Position Open Till</h4>
                                            <p><?=$result[0]->POSITION_OPEN_TILl; ?></p>
