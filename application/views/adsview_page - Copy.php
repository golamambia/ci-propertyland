...
<head>
    ...
    <meta property="og:image" itemprop="image" content="<?=base_url();?>module_file/<?=$ads_view[0]->upload_file;?>" />
    <meta  property="og:title" content="<?=$ads_view[0]->title;?>"  >
    <meta property="og:image:url" itemprop="image" content="<?=base_url();?>module_file/<?=$ads_view[0]->upload_file;?>" />
    <meta property="og:description" content="" />


    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="<?=$ads_view[0]->title;?>" />
    
    <meta name="twitter:site" content="thelocalbrowse.com" />
    <meta name="twitter:image" content="<?=base_url();?>module_file/<?=$ads_view[0]->upload_file;?>" />
    <meta name="twitter:image:width" content="610" />
    <meta name="twitter:image:height" content="610" />

    <title>The local browse</title>
      ...
      <div class="container clearfix">
       ...
       <div class="header-left">
             ...
             <div class="logo">
               ...
               <a href="<?=base_url();?>"><img src="<?=base_url();?>uploads/logo/<?php echo $admin[0]->logo;?>" alt="logo" title=""></a> 
             ...
             <div class="autolocation">
              ...
              <img src="<?php echo base_url();?>assets_front/images/locetion.png" alt="">
                ...
                <select class="form-control" id="countries"> <option value="<?=strtoupper($geo['geoplugin_countryCode']);?>" ><?=$geo['geoplugin_countryName'];?></option></select>
...
<?php } ?>
                                ...
                                <?php //}?>
<?php 
if($ads_view[0]->cat_name!=4 and $ads_view[0]->cat_name!=13){ ?>
...
<?php if($ads_view[0]->cat_name==22 Or $ads_view[0]->cat_name==19){ ?>

                                <div class="box_area">
                                    <div class="heading_area">
                                        <h3><strong>
<?php
if($ads_view[0]->cat_name==22){
    echo 'Delivery Address'; 
}elseif($ads_view[0]->cat_name==19) {
    echo 'JOB Platform/Area'; 
}
...
<?php 
$deliveryId=$ads_view[0]->lbcontactId;
$val=$this->General_model->show_data_id('delivery_location',$deliveryId,'post_id','get','');
$count=0;  foreach ($val as  $value) { $count++; ?>

<p>Location : <?php echo $value->address; ?><br>Location Landmark : <?php echo $value->dl_land_mark; ?></p>                                      
