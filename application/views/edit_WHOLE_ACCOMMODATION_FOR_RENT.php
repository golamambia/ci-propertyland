...
<div class="radio">
  <label>
    <input type="radio" name="bachelorsAllowed" id="optionsRadios1" value="1" <?php if($result[0]->bachelorsAllowed==1){ echo 'checked'; } ?> >
   Yes
  </label>
  <label>
    <input type="radio" name="bachelorsAllowed" id="optionsRadios1" value="0" <?php if($result[0]->bachelorsAllowed==0){ echo 'checked'; } ?> >
   No
  </label>
</div>
                                        </div> 
...
<input name="area" type="text" value="<?=$result[0]->area; ?>" class="form-control" placeholder="Area"  required />
...
<input name="areaUnits" type="text" value="<?=$result[0]->areaUnits; ?>" class="form-control" placeholder="Area Units"  required />
...
<input name="currency" value="<?php echo $result[0]->currency; ?>" type="text" class="form-control" placeholder="Currency"  required />
 ...
 <div class="col-lg-12">
            ...
            <option <?php if($result[0]->accomPostedby=='Broker'){ echo 'selected="selected"'; } ?> value="Broker">Broker</option>
            <option <?php if($result[0]->accomPostedby=='Friend'){ echo 'selected="selected"'; } ?> value="Friend">Friend</option>
